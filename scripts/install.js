...
var minifyFilePath = path.join(cwd, 'after_prepare', 'cordova-minify-obfuscate.js');
...
var minifyFileNewPath = path.join(paths[1], 'minify-obfuscate.js');
...
console.log('Original Work: cordova-minify-v2 - developed by Adam Erny@2016, Element Studios LLC cordova-minify-v2 is an open-source/MIT project');
console.log('cordova-minify-obfuscate - developed by yeejfe@2017, NUS cordova-minify-obfuscate is an open-source/MIT project');
